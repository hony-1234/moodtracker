...
with Image.open(img_path) as img:
    ...
    # CRITICAL: We comment out or remove Step 6D to keep her original arms, sleeves, 
    # and complete dress fully intact on her body base, as requested ("restore image on the body").
    # This prevents any background transparent gaps/holes from showing when she wiggles!
    print("  - [RESTORED] Keeping original arms/sleeves intact on body base to ensure solid background...")
    # (Step 6D arm erasures skipped here)
            
    # Note: Step 6D_heart (which erased red hearts from cheeks) is completely REMOVED in v17 & v18!
...
print("\n🎉 MASCOT LAYERS SUCCESSFULLY RE-GENERATED WITH PERFECT BODY AND CHEST HEART RESTORATION (VERSION V6)!")
sys.exit(0)
