...
with Image.open(img_path) as img:
    ...
    # Define Core Hand Pixels (Strictly no red blush hearts!)
    core_l = set()
    for y in range(lh):
        for x in range(lw):
            r, g, b, a = pixels_l[x, y]
    ...
    # Note: Step 6D_heart (which erased red hearts from cheeks) is completely REMOVED in v16!
    ...
    # 6H. Restore the red chest heart in the center of her dress/chest
    ...
    # Expand to capture dark outlines around the red chest heart
    ...
    print("xinxin_body_base_v6.png completed successfully with chest heart restored!")

print("\n🎉 MASCOT LAYERS SUCCESSFULLY RE-GENERATED FLAWLESSLY WITH PERFECT CHEEK HEART SEPARATION (VERSION V6)!")
sys.exit(0)
