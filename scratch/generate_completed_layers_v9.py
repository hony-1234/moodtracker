...
with Image.open(img_path) as img:
    ...
    # Perform proximity-based classification to completely segment left arm from face cheek
    skin_pixels_l = []
    skin_set_l = set()
    for y in range(lh):
        for x in range(lw):
    ...
    left_arm_absolute_mask = set() # Store absolute coordinates of arm pixels to erase on body base
    ...
    # Perform proximity-based classification to completely segment right arm from face cheek
    skin_pixels_r = []
    skin_set_r = set()
    for y in range(rh):
        for x in range(rw):
    ...
    right_arm_absolute_mask = set() # Store absolute coordinates of arm pixels to erase on body base
