...
with Image.open(img_path) as img:
    ...
    # --- HANDS ---
    print("Step 4: Segmenting left and right hands with optimized distance transform...")
...
print("\n🎉 MASCOT LAYERS SUCCESSFULLY RE-GENERATED FLAWLESSLY WITH PERFECT ELEVATION AND ROTATION JOINTS!")
sys.exit(0)
