...
if os.path.exists(img_path):
    with Image.open(img_path) as img:
        ...
        img_transparent.crop(box_fire).save(os.path.join(folder, "xinxin_fire_v4.png"), "PNG")
        img_transparent.crop(box_left_hand).save(os.path.join(folder, "xinxin_left_hand_v4.png"), "PNG")
        img_transparent.crop(box_right_hand).save(os.path.join(folder, "xinxin_right_hand_v4.png"), "PNG")
        img_transparent.crop(box_legs).save(os.path.join(folder, "xinxin_legs_v4.png"), "PNG")
        img_transparent.crop(box_left_eye).save(os.path.join(folder, "xinxin_left_eye_v4.png"), "PNG")
        img_transparent.crop(box_right_eye).save(os.path.join(folder, "xinxin_right_eye_v4.png"), "PNG")
        ...
        flesh = (246, 225, 199)
        make_transparent(os.path.join(folder, "xinxin_left_eye_v4.png"), flesh, tol=15)
        make_transparent(os.path.join(folder, "xinxin_right_eye_v4.png"), flesh, tol=15)
        print("Cropped segments saved to _v4.png suffixes with perfect eye transparency!")
        ...
        # Fill eye regions on body_base with the skin-tone to leave a clean face
        ...
        body_base.save(os.path.join(folder, "xinxin_body_base_v4.png"), "PNG")
        print("xinxin_body_base_v4.png created with clean solid inpainting!")
        print("\n🎉 ALL ASSETS SUCCESSFULLY RE-SEGMENTED AND INPAINTED (V4)!")
else:
